...
export default class DnCompleted extends React.Component {
  state = {
    selectedRowRecords:'',
    list: [],
        ...
        <Card style={{ marginBottom: '10px' }}>
          <Form ref="formSearch" onFinish={this.handleShowDetail}>
            ...
            <Col span="8">
              ...
              <Col span="8">
                <FormItem label="接单者用户名" name="receiptUserName"{...formItemLayout2}>
                  {
                    <Input allowClear />
                  }
                </FormItem>
            ...
            <Row>
              <Col span="8">
                <FormItem label="接单者姓名" name="receiptRealName"{...formItemLayout2}>
                  {
                    <Input allowClear />
                  }
                </FormItem>
